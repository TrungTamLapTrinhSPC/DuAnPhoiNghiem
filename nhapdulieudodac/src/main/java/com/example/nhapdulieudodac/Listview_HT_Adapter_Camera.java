...
public class Listview_HT_Adapter_Camera extends BaseAdapter {
    ...
    public Listview_HT_Adapter_Camera(Context context, int resource, @NonNull List<HienTrang> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.name.setOnCheckedChangeListener((Camera) mycontext);
