...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acct = GoogleSignIn.getLastSignedInAccount(UserActivity.this);
        ...
        mGoogleSignInClient.signOut()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        startActivity(new Intent(UserActivity.this, MenuTramActivity.class));
                        finish();
                    }
                });
    }
    ...
    private String DialogAdd(){
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else {Toast.makeText(UserActivity.this,"Bạn chưa nhập tên người dùng!",Toast.LENGTH_SHORT).show();}
                dialog.dismiss();
            }
        });
            ...
            new AsyncTask<Void, String, Void>() {
                private String findOrCreateFolder(String prnt, String titl,String kieu, final File fl){
                    ...
                    if (kieu.equals("folder")){
                        ...
                        List<GoogleDriveFileHolder> cvs = mDriveServiceHelper.seachFile(titl,"image/jpeg");
                        if (cvs.size() > 0) {
                            title = "Đã có: ";
                            id =  cvs.get(0).getId();
                        } else {
                            ...
                            try
                            {
                                id = mDriveServiceHelper.uploadImage(fl, "image/jpeg", prnt);
                                title = "Đã đồng bộ: ";
                            }catch (Exception e){
                                title = "Chưa tạo: ";
                            }
                ...
                private String findOrCreateFolder(String prnt, String titl,String kieu, final File fl){
                    ...
                    if (kieu.equals("folder")){
                        ...
                        if (cvs.size() > 0) {
                            ...
                            //id = mDriveServiceHelper.CreateFoler(prnt, titl);
                            id= mDriveServiceHelper.uploadImage(fl,UT.MIME_TXT, prnt);
                            title = "Đã đồng bộ: ";
                        }
                        if (id != null && !title.equals("Đã có: "))
                        {
                ...
                protected Void doInBackground(Void... params) {
                    ...
                    if (folderDataBia.exists()) {
                        ...
                        for (File fileDATA : folderData.listFiles()) {
                            if (IDfolderDataTRAM != null) {
                                List<GoogleDriveFileHolder> cvs = mDriveServiceHelper.search(IDfolderDataTRAM,fileDATA.getName());
                                //Log.d("TT", String.valueOf(cvs.size()));
                                if (cvs.size() == 0) {
                                    File fl = new File(folderData + "/" + fileDATA.getName());///tên hình ảnh
                                    mDriveServiceHelper.uploadImage(fl,UT.MIME_TXT, IDfolderDataTRAM);

                                } else if (cvs.size() != 0) {
                                    try {
                                        mDriveServiceHelper.delete(cvs.get(0).getId());
                                        File fl = new File(folderData + "/" + fileDATA.getName());///tên hình ảnh
