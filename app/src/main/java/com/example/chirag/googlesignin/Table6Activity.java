...
import static com.example.chirag.googlesignin.R.*;
import static com.example.chirag.googlesignin.R.color.*;
import static com.example.chirag.googlesignin.R.color.colorPrimary;

public class Table6Activity extends AppCompatActivity {
    /**KHIA BÁO BIẾN**/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_table6);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SaveAllTable();
                Intent intent3 = new Intent(Table6Activity.this, Table5Activity.class);
                TruyenBien(intent3);
        ...
        btnNext.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                SaveAllTable();
                Intent intent3 = new Intent(Table6Activity.this, Table3Activity.class);
                TruyenBien(intent3);
                startActivity(intent3);
            }
        });
        ...
        btnTrang2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SaveAllTable();
                Intent intent3 = new Intent(Table6Activity.this, Table4Activity.class);
                TruyenBien(intent3);
                startActivity(intent3);
            }
        });
        ...
        btnTrang4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SaveAllTable();
                Intent intent3 = new Intent(Table6Activity.this, Table6Activity.class);
                TruyenBien(intent3);
                startActivity(intent3);
            }
        });
        ...
        btnTable10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }Toast.makeText(Table6Activity.this,"Đã lưu thành công", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    /**BẢNG 101**/
    public void setDataTable101() {
        final  ArrayList<String> listbulong = new ArrayList<String>();
        listbulong.addAll(Arrays.asList("300x300@4-M12/chân","400x400@3-M18/chân","600x600@3-M22/chân"));
        String BULONG = TRABANG(KichThuocCot,listbulong);
        edtBuLong.setText(BULONG);
    ...
    public void AnhXa() {
        btnBack  = (ImageButton) findViewById(id.btnback);
        btnNext = (ImageButton) findViewById(id.btnnext);
        btnHome = (ImageButton) findViewById(R.id.btnHome);
        btnTrang1 = (Button) findViewById(id.btnTrang1);
        btnTrang2 = (Button) findViewById(id.btnTrang2);
        btnTrang3 = (Button) findViewById(id.btnTrang3);
        btnTrang4 = (Button) findViewById(id.btnTrang4);
        btnTable10 = (Button) findViewById(id.btnTable10);
        btnTable11 = (Button) findViewById(id.btnTable11);
        btnTable12 = (Button) findViewById(id.btnTable12);
        btnThemDong = (Button) findViewById(id.btnThemDong);
        Table10 = (TableLayout) findViewById(id.Table10);
        Table11 = (TableLayout) findViewById(id.Table11);
        Table12_V0 = (TableLayout) findViewById(id.Table12_V0);
        Table12_V1 = (TableLayout) findViewById(id.Table12_V1);
        Table12_V2 = (TableLayout) findViewById(id.Table12_V2);
        Table12_V3 = (TableLayout) findViewById(id.Table12_V3);
        edtBuLong = (EditText) findViewById(id.edtBuLong);
        edtKheHo = (EditText) findViewById(id.edtKheHo);
        btnTruyen = (Button) findViewById(id.btnTruyenVaoBang);
        Table101 = (TableLayout) findViewById(id.tbCacKichThuocDienHinh);
        btnTinhDoNghiengCot = (Button) findViewById(id.btnTinhNghieng);
    }
    ...
    private void DialogAnten(final TextView textView,final TextView KichThuoc,final TextView KhoiLuong) {
        ...
        dialog.setContentView(layout.dialog_anten_search);
        dialog.show();
        dialog.setCanceledOnTouchOutside(false);
        Button btnOK = (Button) dialog.findViewById(id.btnRename);
        /**SEARCH VIEW**/
        ArraylistAT.clear();
        ...
        SearchView searchViewCT = (SearchView) dialog.findViewById(id.SearchHientrang);
        ...
        searchViewCT.setQueryHint("Tìm nhanh anten");
        ...
        searchEditTextCK.setTextColor(getResources().getColor(colorPrimary));
        searchEditTextCK.setHintTextColor(getResources().getColor(colorPrimary));
        ImageView searchMagIcon = (ImageView)searchViewCT.findViewById(android.support.v7.appcompat.R.id.search_button);
        searchMagIcon.setImageResource(drawable.ic_search_xam_24dp);
        ...
        Button btnThoat = (Button) dialog.findViewById(id.btnthoat);
    ...
    private void DialogHienTrang(final TextView textView,final TextView textViewHienTrangTren,final TextView textViewDeXuatTren,final TextView textViewDeXuat) {
        final Dialog dialog = new Dialog(this);
        dialog.setContentView(layout.dialog_hientrang_copy);
        dialog.show();
        Button btnOK = (Button) dialog.findViewById(id.btnRename);
        /**SEARCH VIEW**/
        ArraylistHT.clear();
        ...
        Button btnCopy = (Button) dialog.findViewById(id.btnNhuTren);
    ...
    public void SetPopup(final ArrayList<String> listHT, TableLayout table, int rowItem, int columnItem) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final PopupMenu popupMenu = new PopupMenu(Table6Activity.this,textView);
                for (String s:listHT)
        ...
        tvKQ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    {
                        tvKQ.setTextColor(color.colorGreen);
    ...
    private void DialogViewHienTrang(String string,final TextView textView) {
        final Dialog dialog = new Dialog(this);
        dialog.setContentView(layout.dialog_view);
        dialog.show();
        final EditText txtTentram = (EditText) dialog.findViewById(id.txtHienTrang);
    ...
    public void TinhDoNghiengCot()
    {
        ...
        */
        ...
        Vong1.add(X1 = (TextView) findViewById(id.X1));
        Vong1.add(Y1 = (TextView) findViewById(id.Y1));
        Vong1.add(H1 = (TextView) findViewById(id.H1));
        Vong1.add(Dx1 = (TextView) findViewById(id.Dx1));
        Vong1.add(Dy1 = (TextView) findViewById(id.Dy1));
        Vong1.add(e1 = (TextView) findViewById(id.e1));
        Vong1.add(Dl1 = (TextView) findViewById(id.DL1));
        Vong1.add(KL1 = (TextView) findViewById(id.KL1));
        /***Vòng 2**/
        Vong2.add(X2 = (TextView) findViewById(id.X2));
        Vong2.add(Y2 = (TextView) findViewById(id.Y2));
        Vong2.add(H2 = (TextView) findViewById(id.H2));
        Vong2.add(Dx2 = (TextView) findViewById(id.Dx2));
        Vong2.add(Dy2 = (TextView) findViewById(id.Dy2));
        Vong2.add(e2 = (TextView) findViewById(id.e2));
        Vong2.add(Dl2 = (TextView) findViewById(id.DL2));
        Vong2.add(Kl2 = (TextView) findViewById(id.KL2));
        /***Vòng 3**/
        Vong3.add(X3 = (TextView) findViewById(id.X3));
        Vong3.add(Y3 = (TextView) findViewById(id.Y3));
        Vong3.add(H3 = (TextView) findViewById(id.H3));
        Vong3.add(Dx3 = (TextView) findViewById(id.Dx3));
        Vong3.add(Dy3 = (TextView) findViewById(id.Dy3));
        Vong3.add(e3 = (TextView) findViewById(id.e3));
        Vong3.add(Dl3 = (TextView) findViewById(id.DL3));
        Vong3.add(KL3 = (TextView) findViewById(id.KL3));
        int ColumnCount =4;
