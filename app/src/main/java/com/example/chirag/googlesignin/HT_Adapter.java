...
import com.example.listcheckboxhientrang.MainActivityHienTrang;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class HT_Adapter extends BaseAdapter {
    ...
    public HT_Adapter(Context context, int resource, @NonNull List<HienTrang> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.list_item_hientrang, null);
            holder = new ViewHolder();
            holder.code = (TextView) convertView.findViewById(com.example.listcheckboxhientrang.R.id.title_HT);
            holder.name = (CheckBox) convertView.findViewById(com.example.listcheckboxhientrang.R.id.checkbox_HT);
            convertView.setTag(holder);
            holder.name.setOnCheckedChangeListener((Camera2BasicFragment) mycontext);
