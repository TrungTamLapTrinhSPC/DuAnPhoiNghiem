...
public class Listview_HT_Adapter extends BaseAdapter {
    ...
    public Listview_HT_Adapter(Context context, int resource, @NonNull List<HienTrang> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.name.setOnCheckedChangeListener((MainActivityHienTrang) mycontext);
